...
print("\n# use methods from math module")
# print(math)
print(math.ceil(10.46)) # returns the ceiling of the smallest integer greater than or equal(round-up)
print(math.floor(12.8)) # return the floor of x, the largest integer less than or equal to x(round-down)
